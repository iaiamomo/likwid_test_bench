...
INPUT_DIR_STAMP="../stamp_tinySTM/stamp"
...
PAR_kmeans="-m15 -n15 -t0.00001 -i ./inputs/random-n65536-d32-c16.txt thread"
PAR_labyrinth="-i ./inputs/random-x512-y512-z7-n512.txt thread"
PAR_ssca2="-s20 -i1.0 -u1.0 -l3 -p3 thread"
PAR_vacation="-n4 -q60 -u90 -r1048576 -t4194304 thread"
PAR_yada="-a15 -i ./inputs/ttimeu1000000.2 thread"
