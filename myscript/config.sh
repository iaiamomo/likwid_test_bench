...
BENCHS_SPLASH3="raytrace/RAYTRACE radiosity/RADIOSITY volrend/VOLREND"
BENCHS_NAME_SPLASH3="RAYTRACE RADIOSITY VOLREND"

PAR_RAYTRACE="-pPROCESS -m64 -a400 $INPUT_DIR_SPLASH3/raytrace/inputs/car.env"
PAR_RADIOSITY="-p PROCESS -bf 0.0008 -room -batch" 
PAR_VOLREND="PROCESS $INPUT_DIR_SPLASH/volrend/inputs/head 200"
